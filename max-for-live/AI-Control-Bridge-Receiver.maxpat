{
  "patcher": {
    ...
    "boxes": [
      ...
      {"box": {"id": "tosymbol", "maxclass": "newobj", "text": "tosymbol", "patching_rect": [40.0, 100.0, 70.0, 22.0]}},
      {"box": {"id": "deserialize", "maxclass": "newobj", "text": "dict.deserialize", "patching_rect": [40.0, 145.0, 105.0, 22.0]}},
      {"box": {"id": "engine", "maxclass": "newobj", "text": "js bridge_receiver.js", "patching_rect": [40.0, 195.0, 145.0, 22.0]}},
      {"box": {"id": "ack", "maxclass": "newobj", "text": "udpsend 127.0.0.1 9002", "patching_rect": [40.0, 245.0, 165.0, 22.0]}},
    ...
    "lines": [
      {"patchline": {"source": ["in", 0], "destination": ["tosymbol", 0]}},
