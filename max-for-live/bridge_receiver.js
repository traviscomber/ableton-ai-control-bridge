...
function setReturnDeviceParameter(c){var ri=returnTrack(c),r=setParameterOnPath("live_set return_tracks "+ri,c.device,c.parameter,c.value);return {return_track:ri,device:c.device,parameter:c.parameter,value:c.value,device_index:r.device_index,parameter_index:r.parameter_index,readback:r.readback};}
function setMasterDeviceParameter(c){var r=setParameterOnPath("live_set master_track",c.device,c.parameter,c.value);return {device:c.device,parameter:c.parameter,value:c.value,device_index:r.device_index,parameter_index:r.parameter_index,readback:r.readback};}
